...
export const GroupCard: React.FC<GroupCardProps> = ({ 
  ...
  return (
    <div className={`flex flex-col h-full bg-white rounded-2xl shadow-sm border transition-all duration-300 relative ${
      userInGroup ? 'border-indigo-500 ring-4 ring-indigo-500/5' : 'border-gray-200'
    }`}>
      ...
      <div className="p-6 flex-1 relative pt-10">
        ...
        <div className="space-y-3">
          <p className="text-[11px] font-bold text-slate-400 uppercase tracking-widest flex justify-between items-center">
              ...
              {hasFounderSeal && (
                <span className="text-emerald-600 flex items-center gap-1 font-black bg-emerald-50 px-2 py-0.5 rounded-md border border-emerald-100">
                  <Star className="w-3 h-3 fill-emerald-600" /> Structure OK
                </span>
              )}
          </p>
